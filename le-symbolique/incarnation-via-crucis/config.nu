...
source /home/sezrienne/presez/le-symbolique/incarnation-via-crucis/starship/init.nu
source /home/sezrienne/presez/le-symbolique/incarnation-via-crucis/zoxide.nu
...
# The Lord related
  ...
  def paripassu [comment] {git add .; git commit -m $comment; git push --force origin main}
  def reformation [] {/home/sezrienne/.emacs.d/bin/doom sync}

  # Ego conversion
  def greed [] {emacs /home/sezrienne/presez/le-symbolique/signs.nix}
  def incarnate [] {emacs /home/sezrienne/presez/le-symbolique/incarnation-via-crucis/config.nu}
  def reform [] {emacs /home/sezrienne/presez/le-symbolique/scripture-via-crucis/init.el}
